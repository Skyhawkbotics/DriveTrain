...
public class Code20232024NOTIMER extends LinearOpMode {
  //Clock
  ...
  public void whl_corrections() {
    ...
    //3rd mult: weaker overall wheels
      whl_RF_percent = (float) (whl_RF_percent * 0.75 * 0.65 * 1.0 * 0.6);
      whl_RB_percent = (float) (whl_RB_percent * 0.75 *-0.55 *1* 0.6);
      whl_LF_percent = (float) (whl_LF_percent * 0.75 * 0.65 *0.7 * 0.6);
      whl_LB_percent = (float) (whl_LB_percent * 0.75 * -0.6 *1*0.6);
